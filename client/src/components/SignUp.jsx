    ...
    <div className='bg-white p-10 h-[100vh] absolute w-[100vw] '>
      ...
      <div className='h-[80%] relative  w-[60%] pt-4 '>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button className='text-xl bg-gray-400 text-white cursor-pointer font-bold rounded p-2 w-[70%] mt-3.5' type='submit'>SignUp</button>
        </form>
        <p className='text-sm font-bold pt-5'>Already have an account ?<span className='text-black-500 underline cursor-pointer' onClick={() => navigate('/')}>Login</span></p>
      </div>
